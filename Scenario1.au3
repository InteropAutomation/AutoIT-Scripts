...
;
;Date: 30 May 2014 , Modified on 11 June 2014
;Author: Ganesh
;Company: Brillio
;*********************************************************************
...
Local $testCaseJDKOnCloud = _ExcelReadCell($oExcel, 4, 26)
Local $testCaseUserName = _ExcelReadCell($oExcel, 4, 27)
Local $testCasePassword = _ExcelReadCell($oExcel, 4, 28)
