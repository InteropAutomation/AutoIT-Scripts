...
;
;Date: 3 Jun 2014 , Modified on 11 June 2014
;Author: Ganesh
;Company: Brillio
;*********************************************************************
...
Local $testCaseJDKOnCloud = _ExcelReadCell($oExcel, 7, 26)
Local $testCaseUserName = _ExcelReadCell($oExcel, 7, 27)
Local $testCasePassword = _ExcelReadCell($oExcel, 7, 28)
